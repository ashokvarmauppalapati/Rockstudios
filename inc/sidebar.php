                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="">
                                <a href="home.php" class="waves-effect active"><i class="ti-home"></i> <span> Dashboard </span> </a>
                            </li>

                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ti-paint-bucket"></i> <span> Users </span> </a>
                                <ul class="list-unstyled">
                                    <li><a href="create-user.php">User Creation</a></li>
                                </ul>
                            </li>
